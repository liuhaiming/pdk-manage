...
"undefined" != typeof mxResourcePath && 0 < mxResourcePath.length ? ("/" == mxResourcePath.substring(mxResourcePath.length - 1) && (mxResourcePath = mxResourcePath.substring(0, mxResourcePath.length - 1)), mxClient.resourcePath = mxResourcePath) : mxClient.resourcePath = ".";
...
mxClient.imageBasePath = "static/global/plugins/mxgraph/images";
...
mxLoadStylesheets && mxClient.link("stylesheet", mxClient.basePath + "/static/global/plugins/mxgraph/css/common.css");
...
if (mxClient.IS_VML) if (mxClient.IS_SVG) mxClient.IS_VML = !1;
    ...
    mxLoadStylesheets && mxClient.link("stylesheet", mxClient.basePath + "/static/global/plugins/mxgraph/css/explorer.css");
                ...
                e = function() {
                    for (var g = !1,
                        ...
                        if (k instanceof mxGeometryChange || k instanceof mxTerminalChange || k instanceof mxValueChange || k instanceof mxChildChange || k instanceof mxStyleChange) {
                            ...
                            if (null != l) if (g = !0, k.constructor != mxGeometryChange || a.model.isEdge(k.cell)) mxUtils.setOpacity(l.shape.node, 100 * d / 10);
                            else {
                                var m = a.getView().scale,
                                    n = (k.geometry.x - k.previous.x) * m,
                                    p = (k.geometry.y - k.previous.y) * m,
    ...
    mxUtils = {
        ...
        saveAs: function(a) {
            ...
            try {
                ...
                } else c = b.contentWindow.document,
                    c.write(a),
                    c.execCommand("SaveAs", !1, document.location)
            } finally {
        ...
        getScrollOrigin: function(a) {
            for (var b = document.body,
                     ...
                     d = new mxPoint(b.scrollLeft || c.scrollLeft, b.scrollTop || c.scrollTop); null != a && a != b && a != c;) ! isNaN(a.scrollLeft) && !isNaN(a.scrollTop) && (d.x += a.scrollLeft, d.y += a.scrollTop),
                a = a.parentNode;
            return d
        },
...
mxXmlRequest.prototype.send = function(a, b) {
    ...
    null != this.request
        ...
        this.request.open(
            this.method, this.url, this.async, this.username, this.password),
            ...
            function(f) {
                ...
                if ("none" != this.maximize.style.display) {
                    if (a) {
                        ...
                        if (!mxClient.IS_QUIRKS && (this.div.style.height = d, this.div.style.width = e, h = mxUtils.getCurrentStyle(this.contentWrapper), "auto" == h.overflow || null != this.resize)) this.contentWrapper.style.height = this.div.offsetHeight - this.title.offsetHeight - this.contentHeightCorrection + "px";
                        ...
                        if (!mxClient.IS_QUIRKS) {
                            ...
                            if ("auto" == h.overflow || null != this.resize) this.contentWrapper.style.height = this.div.offsetHeight - this.title.offsetHeight - this.contentHeightCorrection + "px"
                        }
...
mxMorphing.prototype.updateAnimation = function() {
    ...
    if (null != this.cells) for (var b = 0; b < this.cells.length; b++) this.animateCell(cells[b], a, !1);
...
mxSvgCanvas2D.prototype.getSvgGradient = function(a, b, c, d, e) {
    ...
    if (null == g) {
        ...
        if (null != h) for (g = h.ownerDocument.getElementById(l); null != g && g.ownerSVGElement != h;) l = f + "-" + k++,
            g = h.ownerDocument.getElementById(l);
...
mxSvgCanvas2D.prototype.createDiv = function(a, b, c, d, e) {
    ...
    mxUtils.isNode(a) || (c = document.createElement("textarea"), c.innerHTML = a.replace(/&lt;/g, "&amp;lt;").replace(/&gt;/g, "&amp;gt;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), a = c.value, "fill" != e && "width" != e ? 0 < b.length && (a = '<div xmlns="http://www.w3.org/1999/xhtml" style="display:inline-block;' + b + '">' + a + "</div>") : d += b);
    if (!mxClient.IS_IE && document.createElementNS) return e = document.createElementNS("http://www.w3.org/1999/xhtml", "div"),
...
mxSvgCanvas2D.prototype.text = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    if (this.textEnabled && null != e) {
        ...
        if (this.foEnabled && "html" == k) {
            ...
            h && 0 < c ? (m || (q += "width:" + Math.round(c) + "px;"), q += "white-space:normal;") : q += "white-space:nowrap;";
            ...
            if (null != q) {
                ...
                if (mxClient.IS_IE && !mxClient.IS_SVG) {
                    ...
                    r.appendChild(q)
                } else this.root.ownerDocument != document || 0 <= navigator.userAgent.indexOf("Firefox/3.") ? (q.style.visibility = "hidden", document.body.appendChild(q), t = q.offsetWidth, u = q.offsetHeight, r.appendChild(q), q.style.visibility = "") : (r.appendChild(q), t = q.offsetWidth, u = q.offsetHeight); ! m && (h && q.scrollWidth > t) && (t = Math.max(t, q.scrollWidth), q.style.width = t + "px");
                ...
                0 != p.rotation && this.rotateHtml ? (u += "rotate(" + p.rotation + "," + c / 2 + "," + d / 2 + ")", b = this.rotatePoint((a + c / 2) * p.scale, (b + d / 2) * p.scale, p.rotation, p.rotationCx, p.rotationCy), a = b.x - c * p.scale / 2, b = b.y - d * p.scale / 2) : (a *= p.scale, b *= p.scale);
                0 != n && (u += "rotate(" + n + "," + -q + "," + -t + ")");
                ...
                this.root.ownerDocument != document && (a = this.createAlternateContent(r, a, b, c, d, e, f, g, h, k, l, m, n), null != a && (r.setAttribute("requiredFeatures", "http://www.w3.org/TR/SVG11/feature#Extensibility"), c = this.createElement("switch"), c.appendChild(r), c.appendChild(a), s.appendChild(c)))
            }
...
mxSvgCanvas2D.prototype.plainText = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (l = 0; l < q.length; l++) 0 < q[l].length && 0 < mxUtils.trim(q[l]).length && (n = this.createElement("text"), n.setAttribute("x", this.format(a * h.scale)), n.setAttribute("y", this.format(m * h.scale)), this.updateFont(n), mxUtils.write(n, q[l]), p.appendChild(n)),
        m += s;
    this.root.appendChild(p);
...
mxVmlCanvas2D.prototype.createShadow = function(a, b, c) {
    ...
    8 == document.documentMode && (k.strokeweight = a.strokeweight, "shape" == a.nodeName && (k.path = this.path.join(" ") + " e", k.style.width = this.root.style.width, k.style.height = this.root.style.height, k.coordsize = parseInt(a.style.width) + " " + parseInt(a.style.height)));
...
mxVmlCanvas2D.prototype.createDiv = function(a, b, c, d) {
    ...
    mxUtils.isNode(a) ? c.appendChild(a) : 0 < f.length && "fill" != d && "width" != d ? (d = document.createElement("div"), d.style.cssText = f, d.style.display = mxClient.IS_QUIRKS ? "inline": "inline-block", d.style.zoom = "1", d.innerHTML = a, c.appendChild(d)) : (c.style.cssText = f, c.innerHTML = a);
    a = c.style;
...
mxVmlCanvas2D.prototype.text = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    if (this.textEnabled && null != e) {
        ...
        if ("html" == k) {
            ...
            n = p.rotation + (n || 0);
            this.rotateHtml && 0 != n ? (f.style.display = "inline", f.style.zoom = "1", f.appendChild(e), 8 == document.documentMode && "DIV" != this.root.nodeName ? (q.appendChild(f), k.appendChild(q)) : k.appendChild(f)) : 8 == document.documentMode ? (q.appendChild(e), k.appendChild(q)) : (e.style.display = "inline", k.appendChild(e));
            ...
            m ? (e.style.overflow = "hidden", 0 < c && (e.style.width = Math.round(c) + "px"), 0 < d && 8 == document.documentMode && (e.style.maxHeight = Math.round(d) + "px")) : "fill" == l ? (e.style.width = c + "px", e.style.height = d + "px") : "width" == l && (e.style.width = c + "px", 0 < d && (e.style.maxHeight = Math.round(d) + "px"));
            if (this.rotateHtml && 0 != n) {
                ...
                document.body.appendChild(e);
                c = e.offsetWidth;
                q = e.offsetHeight; ! m && h && (c = Math.max(c, e.scrollWidth), e.style.width = c + "px");
                if (mxClient.IS_QUIRKS && (m || "width" == l) && q > d) q = d,
                    e.style.height = q + "px";
                d = q;
                m = (d - d * t + c * -u) / 2 - g * c * (r + 0.5) + n * d * (s + 0.5);
                h = (c - c * t + d * -u) / 2 + n * c * (r + 0.5) + g * d * (s + 0.5);
                "group" == k.nodeName && "DIV" == this.root.nodeName ? (l = document.createElement("div"), l.style.display = "inline-block", l.style.position = "absolute", l.style.left = this.format(a + (h - c / 2) * p.scale) + "px", l.style.top = this.format(b + (m - d / 2) * p.scale) + "px", k.parentNode.appendChild(l), l.appendChild(k)) : (p = 8 == document.documentMode ? 1 : p.scale, k.style.left = this.format(a + (h - c / 2) * p) + "px", k.style.top = this.format(b + (m - d / 2) * p) + "px");
                ...
                e.style.visibility = "";
                f.appendChild(e)
            } else 8 != document.documentMode ? (e.style.verticalAlign = "top", 1 > this.state.alpha && (k.style.filter = "alpha(opacity=" + 100 * this.state.alpha + ")"), p = e.parentNode, e.style.visibility = "hidden", document.body.appendChild(e), c = e.offsetWidth, q = e.offsetHeight, mxClient.IS_QUIRKS && (m && q > d) && (q = d, e.style.height = q + "px"), d = q, e.style.visibility = "", p.appendChild(e), k.style.left = this.format(a + c * r * this.state.scale) + "px", k.style.top = this.format(b + d * s * this.state.scale) + "px") : (1 > this.state.alpha && (e.style.filter = "alpha(opacity=" + 100 * this.state.alpha + ")"), q.style.left = 100 * r + "%", q.style.top = 100 * s + "%")
...
mxVmlCanvas2D.prototype.plainText = function(a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    d.style.fontSize = f + "px"; (h.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD && (d.style.fontWeight = "bold"); (h.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC && (d.style.fontStyle = "italic"); (h.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE && (d.style.textDecoration = "underline");
    e = e.split("\n");
...
mxGuide.prototype.move = function(a, b, c) {
    if (null != this.states && (this.horizontal || this.vertical) && null != a && null != b) {
        ...
        b = function(b) {
            b += this.graph.panDx;
            var c = !1;
            Math.abs(b - s) < m ? (f = b - a.getCenterX(), m = Math.abs(b - s), c = !0) : Math.abs(b - p) < m ? (f = b - a.x, m = Math.abs(b - p), c = !0) : Math.abs(b - q) < m && (f = b - a.x - a.width, m = Math.abs(b - q), c = !0);
            if (c) {
        ...
        } ! h && null != this.guideX ? this.guideX.node.style.visibility = "hidden": null != this.guideX && (this.guideX.node.style.visibility = "visible", this.guideX.redraw()); ! k && null != this.guideY ? this.guideY.node.style.visibility = "hidden": null != this.guideY && (this.guideY.node.style.visibility = "visible", this.guideY.redraw());
...
mxStencil.prototype.drawChildren = function(a, b, c, d, e, f, g, h) {
    if (null != g && 0 < e && 0 < f) {
        ...
        a.setStrokeWidth(d);
        for (g = g.firstChild; null != g;) g.nodeType == mxConstants.NODETYPE_ELEMENT && this.drawNode(a, b, g, c, h),
            g = g.nextSibling
    }
};
...
mxStencil.prototype.drawNode = function(a, b, c, d, e) {
    ...
    else if ("line" == f) a.lineTo(g + Number(c.getAttribute("x")) * k, h + Number(c.getAttribute("y")) * l);
    ...
    else if ("arc" == f) a.arcTo(Number(c.getAttribute("rx")) * k, Number(c.getAttribute("ry")) * l, Number(c.getAttribute("x-axis-rotation")), Number(c.getAttribute("large-arc-flag")), Number(c.getAttribute("sweep-flag")), g + Number(c.getAttribute("x")) * k, h + Number(c.getAttribute("y")) * l);
    ...
    0 == b && (b = 100 * mxConstants.RECTANGLE_ROUNDING_FACTOR),
        m = Number(c.getAttribute("w")) * k,
        d = Number(c.getAttribute("h")) * l,
        b = Number(b) / 100,
        b = Math.min(m * b, d * b),
        a.roundrect(g + Number(c.getAttribute("x")) * k, h + Number(c.getAttribute("y")) * l, m, d, b, b);
        ...
        a.image(g + Number(c.getAttribute("x")) * k, h + Number(c.getAttribute("y")) * l, Number(c.getAttribute("w")) * k, Number(c.getAttribute("h")) * l, b, !1, "1" == c.getAttribute("flipH"), "1" == c.getAttribute("flipV"));
    else if ("text" == f) {
    ...
    else if ("strokewidth" == f) k = "1" == c.getAttribute("fixed") ? 1 : m,
        a.setStrokeWidth(Number(c.getAttribute("width")) * k);
...
mxShape.prototype.clear = function() {
    if (null != this.node.ownerSVGElement) for (this.node.style.visibility = "visible"; null != this.node.lastChild;) this.node.removeChild(this.node.lastChild);
...
mxPolyline.prototype.paintLine = function(a, b, c) {
    ...
    for (var g = 1; g < b.length - 1; g++) {
        ...
        if (c && g < b.length - 1 && (0 != k || 0 != e)) {
            ...
            for (e = b[g + 1]; g < b.length - 2 && 0 == Math.round(e.x - h.x) && 0 == Math.round(e.y - h.y);) e = b[g + 2],
                g++;
            k = e.x - h.x;
            e = e.y - h.y;
    ...
    if (!this.ignoreStringSize && null != a && "fill" != this.overflow && (!this.clipped || !this.ignoreClippedStringSize)) {
        ...
        if (null != a.ownerSVGElement) if (null != a.firstChild && null != a.firstChild.firstChild && "foreignObject" == a.firstChild.firstChild.nodeName) a = a.firstChild.firstChild,
            ...
            d = parseInt(a.getAttribute("height")) * this.scale;
                ...
                b = 0
            } catch(f) {} else d = null != this.state ? this.state.view.textDiv: null,
            null != this.offsetWidth && null != this.offsetHeight ? (c = this.wrap ? this.bounds.width: this.offsetWidth * this.scale, d = this.offsetHeight * this.scale) : null != d ? (this.updateFont(d), this.updateSize(d), mxUtils.isNode(this.value) ? d.innerHTML = this.value.outerHTML: (a = this.replaceLinefeeds ? this.value.replace(/\n/g, "<br/>") : this.value, d.innerHTML = a), c = this.wrap ? this.bounds.width: d.offsetWidth * this.scale, d = d.offsetHeight * this.scale) : (c = this.wrap ? this.bounds.width: a.offsetWidth * this.scale, d = a.offsetHeight * this.scale);
...
mxText.prototype.paint = function(a) {
    ...
    var f = mxUtils.isNode(this.value) || this.dialect == mxConstants.DIALECT_STRICTHTML,
        ...
        h = this.value; ! f && "html" == g && (h = mxUtils.htmlEntities(h, !1));
...
mxLabel.prototype.getImageBounds = function(a, b, c, d) {
    ...
    a = e == mxConstants.ALIGN_CENTER ? a + (c - g) / 2 : e == mxConstants.ALIGN_RIGHT ? a + (c - g - k) : a + k;
...
mxLabel.prototype.getIndicatorBounds = function(a, b, c, d) {
    var e = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_ALIGN, mxConstants.ALIGN_LEFT),
        ...
        k = this.spacing + 5;
    a = e == mxConstants.ALIGN_RIGHT ? a + (c - g - k) : e == mxConstants.ALIGN_CENTER ? a + (c - g) / 2 : a + k;
...
mxConnector.prototype.createMarker = function(a, b, c) {
    var d = null,
        ...
        g = c ? b[0] : b[e - 1];
    if (null != f && null != g) {
        for (d = 1; d < e - 1 && 0 == Math.round(f.x - g.x) && 0 == Math.round(f.y - g.y);) f = c ? b[1 + d] : b[e - 2 - d],
            d++;
        b = g.x - f.x;
        e = g.y - f.y;
        ...
        d = mxMarker.createMarker(a, this, d, g, f, b, e, c, this.strokewidth, 0 != this.style[c ? mxConstants.STYLE_STARTFILL: mxConstants.STYLE_ENDFILL])
    }
    return d
};
...
mxSwimlane.prototype.paintRoundedSwimlane = function(a, b, c, d, e, f, g, h, k) {
    ...
    k && a.close();
    a.fillAndStroke();
    f < e && h == mxConstants.NONE && (a.pointerEvents = !1, a.begin(), a.moveTo(0, f), a.lineTo(0, e - g), a.quadTo(0, e, Math.min(d / 2, g), e), a.lineTo(d - Math.min(d / 2, g), e), a.quadTo(d, e, d, e - g), a.lineTo(d, f), a.stroke())
};
...
mxGraphLayout.traverse = function(a, b, c, d, e) {
    if (null != c && null != a) {
        ...
        if (null == e[f] && (e[f] = a, d = c(a, d), null == d || d)) if (d = this.graph.model.getEdgeCount(a), 0 < d) for (f = 0; f < d; f++) {
            ...
            if (!b || h) h = this.graph.view.getVisibleTerminal(g, !h),
                this.traverse(h, b, c, g, e)
        }
    }
};
    ...
    try {
        for (var c = a.length - 1; 0 <= c; c--) {
            ...
            if (this.graph.isSwimlane(d)) var l = this.graph.getStartSize(d),
                h = l.width,
                k = l.height;
            null != f && null != g && (g = g.clone(), g.x = g.x + f.x - b - h, g.y = g.y + f.y - b - k, g.width = f.width + 2 * b + h, g.height = f.height + 2 * b + k, this.graph.getModel().setGeometry(d, g), this.graph.moveCells(e, b + h - f.x, b + k - f.y))
        }
    } finally {
    ...
    if (null != a) {
        ...
        if (this.graph.isSwimlane(a)) {
            var h = this.graph.getCellStyle(a),
                ...
                h = 1 == mxUtils.getValue(h, mxConstants.STYLE_HORIZONTAL, !0);
        ...
        try {
            for (var k = 0,
                     h = null,
                     l = d.getChildCount(a), m = 0; m < l; m++) {
                var n = d.getChildAt(a, m);
                if (!this.isVertexIgnored(n) && this.isVertexMovable(n)) {
                    var p = d.getGeometry(n);
                    if (null != p) {
                        p = p.clone();
                        if (null != this.wrap && null != h && (c && h.x + h.width + p.width + 2 * this.spacing > this.wrap || !c && h.y + h.height + p.height + 2 * this.spacing > this.wrap)) h = null,
                            c ? g += k + this.spacing: f += k + this.spacing,
                            k = 0;
...
mxCompactTreeLayout.prototype.execute = function(a, b) {
    this.parent = a;
    var c = this.graph.getModel();
    if (null == b) if (0 < this.graph.getEdges(a, c.getParent(a), this.invert, !this.invert, !1).length) b = a;
    else {
    ...
    if (null != b) {
        ...
        try {
            var f = this.dfs(b, a);
            this.alignRanks && (this.maxRankHeight = [], this.findRankHeights(f, 0), this.setCellHeights(f, 0));
            if (null != f) {
                this.layout(f);
                ...
                if (null != h) {
                    ...
                    0 > h.y && (k = Math.abs(d - h.y)); (0 != e || 0 != k) && this.moveNode(f, e, k);
...
mxCompactTreeLayout.prototype.processNodeOutgoing = function(a) {
    ...
    for (var f = this.minEdgeJetty - this.prefVertEdgeOff,
        ...
        for (var l = e[k].cell.cell, m = this.getVertexBounds(l), l = this.graph.getEdgesBetween(c, l, !1), n = [], p = 0, q = 0, s = 0; s < l.length; s++) this.horizontal ? (p = h.x + h.width, q = h.y + b, n.push(new mxPoint(p, q)), p = h.x + h.width + f, n.push(new mxPoint(p, q)), q = m.y + m.height / 2) : (p = h.x + b, q = h.y + h.height, n.push(new mxPoint(p, q)), q = h.y + h.height + f, n.push(new mxPoint(p, q)), p = m.x + m.width / 2),
...
mxFastOrganicLayout.prototype.execute = function(a) {
    ...
    try {
        ...
        this.isVertexMovable(g) && (k = this.getVertexBounds(g), null != k && (this.cellLocation[d][0] -= k.width / 2, this.cellLocation[d][1] -= k.height / 2, n = this.graph.snap(this.cellLocation[d][0]), p = this.graph.snap(this.cellLocation[d][1]), this.setVertexLocation(g, n, p), c = null == c ? n: Math.min(c, n), a = null == a ? p: Math.min(a, p)));
        d = -(c || 0) + 1;
        g = -(a || 0) + 1;
        null != e && (d += e.x, g += e.y);
...
mxGraphHierarchyModel.prototype.initialRank = function() {
    ...
    for (var d in this.vertexMapper) c = this.vertexMapper[d],
        c.temp[0] = -1;
    for (var e = a.slice(); 0 < a.length;) {
        ...
        if (h) {
            ...
            if (null != g) for (b = 0; b < g.length; b++) l = g[b],
                l.temp[0] = 5270620,
                l = l.target,
    ...
    for (d in this.vertexMapper) c = this.vertexMapper[d],
        c.temp[0] -= this.maxRank;
    for (b = 0; b < e.length; b++) {
        ...
        for (d = 0; d < f.length; d++) l = f[d],
            l = l.target,
            c.temp[0] = Math.max(a, l.temp[0] + 1),
            a = c.temp[0]
    }
    ...
    for (var d = a.getGraph(), e = a.swimlanes, f = 0; f < b.length; f++) {
        ...
        for (var h = 0; h < g.length; h++) {
            ...
            if (k != b[f] && a.graph.model.isVertex(k) && !a.isVertexIgnored(k)) {
                var l = a.getEdgesBetween(b[f], k, !1),
...
mxSwimlaneModel.prototype.initialRank = function() {
    ...
    for (a.slice(); 0 < a.length;) {
        ...
        for (var g = !0,
                 h = b[0], c = 0; c < e.length; c++) {
            var k = e[c];
            if (5270620 == k.temp[0]) k = k.source,
                h = Math.min(h, k.temp[0] - 1);
            else {
                g = !1;
                break
            }
        ...
        if (g) {
            ...
            d.temp[0] = h;
            if (null != f) for (c = 0; c < f.length; c++) k = f[c],
                k.temp[0] = 5270620,
                k = k.target,
            -1 == k.temp[0] && (a.push(k), k.temp[0] = -2);
            a.shift()
...
mxMedianHybridCrossingReduction.prototype.calculateRankCrossing = function(a, b) {
    ...
    for (h = 0; h < e; h++) for (k = 0; k < f; k++) if (201207 == g[h][k]) {
        ...
        for (d = 0; d < h; d++) for (l = k + 1; l < f; l++) 201207 == g[d][l] && c++
    }
    return c / 2
};
mxMedianHybridCrossingReduction.prototype.transpose = function(a, b) {
    for (var c = !0,
        ...
        for (var n = m = l = null,
            ...
            for (var y = 0,
                     z = 0,
                     w = 0; w < q.length; w++) for (var x = 0; x < r.length; x++) q[w] > r[x] && y++,
            q[w] < r[x] && z++;
            ...
            if (z < y || z == y && e) n = u.getGeneralPurposeVariable(f),
                ...
                v.setGeneralPurposeVariable(f, n),
                n = l,
                p = m,
                r = q,
                t = s,
...
mxMinimumCycleRemover.prototype.execute = function(a) {
    ...
    if (null != e && 0 < e.length) {
        b = b.roots;
        for (a = 0; a < e.length; a++) g = e[a].cell,
        0 == f.getIncomingEdges(g).length && b.push(g)
    }
};
...
mxCoordinateAssignment.prototype.minNode = function(a) {
    ...
    for (f = 0; 0 < b.length && f <= a;) {
        var h = b.shift(),
            ...
            s = this.medianXValue(m, k - 1),
            r = n + p,
            t = e.getGeneralPurposeVariable(k),
            u = t;
        0 < r && (u = (q * n + s * p) / r);
        n = !1;
        u < t - 1 ? 0 == l ? (e.setGeneralPurposeVariable(k, u), n = !0) : (l = d[k][l - 1], t = l.getGeneralPurposeVariable(k), t = t + l.width / 2 + this.intraCellSpacing + e.width / 2, t < u ? (e.setGeneralPurposeVariable(k, u), n = !0) : t < e.getGeneralPurposeVariable(k) - 1 && (e.setGeneralPurposeVariable(k, t), n = !0)) : u > t + 1 && (l == d[k].length - 1 ? (e.setGeneralPurposeVariable(k, u), n = !0) : (l = d[k][l + 1], t = l.getGeneralPurposeVariable(k), t = t - l.width / 2 - this.intraCellSpacing - e.width / 2, t > u ? (e.setGeneralPurposeVariable(k, u), n = !0) : t > e.getGeneralPurposeVariable(k) + 1 && (e.setGeneralPurposeVariable(k, t), n = !0)));
        if (n) {
            for (e = 0; e < g.length; e++) k = g[e],
                k = mxCellPath.create(k.getCoreCell()),
                k = c[k],
            null != k && !1 == k.visited && (k.visited = !0, b.push(k));
            for (e = 0; e < m.length; e++) k = m[e],
                k = mxCellPath.create(k.getCoreCell()),
                k = c[k],
            null != k && !1 == k.visited && (k.visited = !0, b.push(k))
        }
...
mxCoordinateAssignment.prototype.rankMedianPosition = function(a, b, c) {
    ...
    for (f = 0; f < d.length; f++) {
        ...
        for (m = d[f].rankIndex + 1; m < d.length;) if (n = mxCellPath.create(b[m].getCoreCell()), n = e[n], null != n) {
            var q = n.cell;
            n.visited ? (p = q.getGeneralPurposeVariable(a) - q.width / 2 - this.intraCellSpacing - l - g.width / 2, m = d.length) : (l += q.width + this.intraCellSpacing, m++)
        }
...
mxCoordinateAssignment.prototype.rankCoordinates = function(a, b, c) {
    ...
    for (var d = this.initialX + (this.widestRankValue - this.rankWidths[a]) / 2, e = !1, f = 0; f < b.length; f++) {
        ...
        } else g.isEdge() && (h = 1, null != g.edges ? h = g.edges.length: mxLog.warn("edge.edges is null"), g.width = (h - 1) * this.parallelEdgeSpacing);
        d += g.width / 2;
        g.setX(a, d);
...
mxCoordinateAssignment.prototype.calculateWidestRank = function(a, b) {
    ...
    for (var e = b.maxRank; 0 <= e; e--) {
        for (var f = 0,
                 g = b.ranks[e], h = this.initialX, k = !1, l = 0; l < g.length; l++) {
            var m = g[l];
            if (m.isVertex()) {
            ...
            } else m.isEdge() && (n = 1, null != m.edges ? n = m.edges.length: mxLog.warn("edge.edges is null"), m.width = (n - 1) * this.parallelEdgeSpacing);
            h += m.width / 2;
            m.setX(e, h);
...
mxCoordinateAssignment.prototype.minPath = function(a, b) {
    ...
    for (d in c) {
        ...
        if (! (1 > e.maxRank - e.minRank - 1)) {
            ...
            if (!g) {
                for (var g = f = 0,
                         l = [], m = [], n = e.getGeneralPurposeVariable(e.minRank + 1), k = e.minRank + 1; k < e.maxRank - 1; k++) {
                    var p = e.getX(k + 1);
                    n == p ? (l[k - e.minRank - 1] = n, f++) : this.repositionValid(b, e, k + 1, n) ? (l[k - e.minRank - 1] = n, f++) : n = l[k - e.minRank - 1] = p
                }
                n = e.getX(k);
                for (k = e.maxRank - 1; k > e.minRank + 1; k--) p = e.getX(k - 1),
                    n == p ? (m[k - e.minRank - 2] = n, g++) : this.repositionValid(b, e, k - 1, n) ? (m[k - e.minRank - 2] = n, g++) : (m[k - e.minRank - 2] = e.getX(k - 1), n = p);
                if (g > h || f > h) if (g >= f) for (k = e.maxRank - 2; k > e.minRank; k--) e.setX(k, m[k - e.minRank - 1]);
                else if (f > g) for (k = e.minRank + 2; k < e.maxRank; k++) e.setX(k, l[k - e.minRank - 2])
            }
        }
    }
};
            ...
            if ( - 1 < g && g < a.ranks.length && null != f && 0 < f.length) {
                ...
                for (var m = e.x[0] - e.width / 2, n = m + e.width, p = f = 0, g = [], l = 0; l < k.length; l++) {
                    ...
                    if (q.isVertex()) {
                        ...
                        for (var r = 0; r < s.length; r++) if (s[r].source == q || s[r].target == q) f += s[r].edges.length,
                            p++,
                            g.push(s[r])
                    } else f += q.edges.length,
                        p++,
                        g.push(q)
                }
...
mxCoordinateAssignment.prototype.setEdgePosition = function(a) {
    ...
    if (101207 != a.temp[0]) {
        ...
        for (var e = 0,
                 f = mxCellPath.create(a.edges[0]), f = this.jettyPositions[f], g = a.isReversed ? a.target.cell: a.source.cell, h = this.layout.graph, k = 0; k < a.edges.length; k++) {
            var l = a.edges[k],
...
mxHierarchicalLayout.prototype.run = function(a) {
    ...
    } else for (e = 0; e < this.roots.length; e++) h = {},
        b.push(h),
        this.traverse(this.roots[e], !0, null, c, h, b, null);
...
mxHierarchicalLayout.prototype.getEdgesBetween = function(a, b, c) {
    ...
    for (var d = this.getEdges(a), e = [], f = 0; f < d.length; f++) {
        var g = this.getVisibleTerminal(d[f], !0),
            h = this.getVisibleTerminal(d[f], !1); (g == a && h == b || !c && g == b && h == a) && e.push(d[f])
    }
    return e
};
mxHierarchicalLayout.prototype.traverse = function(a, b, c, d, e, f, g) {
    if (null != a && null != d) {
        ...
        if (null == d[h] && (null == g || null != g[h])) {
            ...
            for (c = 0; c < k.length; c++) if (h = this.getVisibleTerminal(k[c], !0) == a, !b || h) h = this.getVisibleTerminal(k[c], !h),
    ...
    if (null != a && null != d) {
        ...
        if (null == d[k] && (null == g || null != g[k])) {
            ...
            for (c = 0; c < l.length; c++) {
                ...
                for (var p = 0,
                         p = 0; p < this.swimlanes.length && !k.isAncestor(this.swimlanes[p], m); p++);
                if (! (p >= this.swimlanes.length) && (p > h || (!b || n) && p == h)) e = this.traverse(m, b, l[c], d, e, f, g, p)
            }
...
mxGraphModel.prototype.getEdges = function(a, b, c, d) {
    ...
    for (var e = this.getEdgeCount(a), f = [], g = 0; g < e; g++) {
        var h = this.getEdgeAt(a, g),
            ...
            l = this.getTerminal(h, !1); (d && k == l || k != l && (b && l == a || c && k == a)) && f.push(h)
    }
    return f
};
mxGraphModel.prototype.getEdgesBetween = function(a, b, c) {
    ...
    for (e = 0; e < g; e++) {
        var h = this.getEdgeAt(f, e),
            ...
            m = l == a && k == b; (k == a && l == b || !c && m) && d.push(h)
    }
    return d
};
...
mxGeometry.prototype.translate = function(a, b) {
    ...
    if (this.TRANSLATE_CONTROL_POINTS && null != this.points) for (var c = this.points.length,
                                                                       d = 0; d < c; d++) {
        var e = this.points[d];
        null != e && (e.x += a, e.y += b)
    }
...
var mxCellPath = {
    ...
    mxPerimeter = {
        RectanglePerimeter: function(a, b, c, d) {
            ...
            f < -h + l || f > h - l ? (g.x = a.x, g.y = e - a.width * Math.tan(f) / 2) : f < -l ? (g.y = a.y, g.x = b - a.height * Math.tan(k) / 2) : f < l ? (g.x = a.x + a.width, g.y = e + a.width * Math.tan(f) / 2) : (g.y = a.y + a.height, g.x = b + a.height * Math.tan(k) / 2);
        ...
        EllipsePerimeter: function(a, b, c, d) {
            ...
            if (d) {
                if (c >= f && c <= f + a.height) return a = c - l,
                    a = Math.sqrt(g * g * (1 - a * a / (h * h))) || 0,
                b <= e && (a = -a),
                    new mxPoint(k + a, c);
                if (b >= e && b <= e + a.width) return a = b - k,
...
mxPrintPreview.prototype.open = function(a) {
    ...
    try {
        ...
        if (null == this.wnd) {
            ...
            for (var t = this.getAppendices(this.pageFormat.width, this.pageFormat.height), r = 0; r < p; r++) for (var u = r * m / this.scale - this.y0 / this.scale + (f.y - k.y * g) / g, s = 0; s < n; s++) {
                if (null == this.wnd) return null;
                var v = s * l / this.scale - this.x0 / this.scale + (f.x - k.x * g) / g,
                    w = r * n + s + 1,
                    c = 8 == d.documentMode || 9 == d.documentMode || 10 == d.documentMode ? this.renderPage(this.pageFormat.width, this.pageFormat.height, -v, -u, mxUtils.bind(this,
                        function(a) {
...
mxPrintPreview.prototype.writeHead = function(a, b) {
    ...
    mxClient.link("stylesheet", mxClient.basePath + "/static/global/plugins/mxgraph/css/common.css", a);
...
mxPrintPreview.prototype.renderPage = function(a, b, c, d, e) {
    ...
    try {
        ...
        8 == f.documentMode && (g.style.position = "relative"),
            ...
            h.style.height = b - 2 * this.border + "px",
            h.style.overflow = "hidden",
            mxClient.IS_IE && (null == f.documentMode || 5 == f.documentMode || 8 == f.documentMode || 7 == f.documentMode) ? (h.style.marginTop = this.border + "px", h.style.marginLeft = this.border + "px") : (h.style.top = this.border + "px", h.style.left = this.border + "px"),
        this.graph.dialect == mxConstants.DIALECT_VML && (h.style.position = "absolute"),
            g.appendChild(h),
            document.body.appendChild(g),
            e(h)
    } catch(l) {
...
mxPrintPreview.prototype.addGraphFragment = function(a, b, c, d, e) {
    ...
    try {
        ...
        else for (c = e.firstChild; null != c;) q = c.nextSibling,
...
mxCellEditor.prototype.init = function() {
    ...
    mxEvent.addListener(this.textarea, !mxClient.IS_IE || 9 <= document.documentMode ? "input": "keypress", mxUtils.bind(this,
        function(a) {
    ...
    if (null != this.textDiv) {
        ...
        if (null == a) this.stopEditing(!0);
            ...
            var b = this.graph.isLabelClipped(a.cell),
                ...
                h = (parseInt(a.style[mxConstants.STYLE_SPACING_RIGHT] || 0) + mxText.prototype.baseSpacingRight) * e + f,
            ...
            d ? (this.bounds.x = a.absoluteOffset.x, this.bounds.y = a.absoluteOffset.y, this.bounds.width = 0, this.bounds.height = 0) : null != this.bounds && (this.bounds.x = g.x, this.bounds.y = g.y, this.bounds.width = g.width, this.bounds.height = g.height, d = mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_POSITION, mxConstants.ALIGN_CENTER), d == mxConstants.ALIGN_LEFT ? this.bounds.x -= a.width: d == mxConstants.ALIGN_RIGHT && (this.bounds.x += a.width), d = mxUtils.getValue(a.style, mxConstants.STYLE_VERTICAL_LABEL_POSITION, mxConstants.ALIGN_MIDDLE), d == mxConstants.ALIGN_TOP ? this.bounds.y -= a.height: d == mxConstants.ALIGN_BOTTOM && (this.bounds.y += a.height));
...
mxCellEditor.prototype.getEditorBounds = function(a) {
    var b = this.graph.getModel().isEdge(a.cell),
        ...
        k = (parseInt(a.style[mxConstants.STYLE_SPACING_BOTTOM] || 0) + mxText.prototype.baseSpacingBottom) * c + f,
    ...
    b ? (h.x = a.absoluteOffset.x, h.y = a.absoluteOffset.y, null != a.text && null != a.text.boundingBox && (0 < a.text.boundingBox.x && (h.x = a.text.boundingBox.x), 0 < a.text.boundingBox.y && (h.y = a.text.boundingBox.y))) : null != a.text && null != a.text.boundingBox && (h.x = Math.min(h.x, a.text.boundingBox.x), h.y = Math.min(h.y, a.text.boundingBox.y));
    h.x += c;
    h.y += g;
...
mxCellRenderer.prototype.installListeners = function(a) {
    var b = a.view.graph,
        c = function(c) {
            var d = a;
            if (b.dialect != mxConstants.DIALECT_SVG && "IMG" == mxEvent.getSource(c).nodeName || mxClient.IS_TOUCH) d = mxEvent.getClientX(c),
        ...
        d = !1;
    mxClient.IS_TOUCH && (mxEvent.addListener(a.shape.node, "gesturestart", mxUtils.bind(this,
        function(a) {
            b.lastTouchTime = 0;
            d = !0;
            mxEvent.consume(a)
        })), mxEvent.addListener(a.shape.node, "gestureend", mxUtils.bind(this,
        function(c) {
            d = !1;
...
mxCellRenderer.prototype.getLabelBounds = function(a) {
    ...
    } else a.text.isPaintBoundsInverted() && (f = e.x, e.x = e.y, e.y = f),
        e.x += a.x,
        e.y += a.y,
        e.width = Math.max(1, a.width),
        e.height = Math.max(1, a.height),
    b.isSwimlane(a.cell) && (b = b.getStartSize(a.cell), 0 < b.width ? (f = Math.min(e.width, b.width * c), a.shape.flipH && (e.x += e.width - f), e.width = f) : 0 < b.height && (f = Math.min(e.height, b.height * c), a.shape.flipV && (e.y += e.height - f), e.height = f));
...
mxCellRenderer.prototype.redrawCellOverlays = function(a, b) {
    ...
    if (null != a.overlays) {
        ...
        a.overlays.visit(function(d, h) {
            ...
            if (b || null == h.bounds || h.scale != a.view.scale || !h.bounds.equals(k)) h.bounds = k,
    ...
    if (null != a.control) {
        ...
        if (!a.view.graph.getModel().isEdge(a.cell) && (e = a.x + c * d, f = a.y + b * d, null != a.shape)) {
            ...
            if (this.legacyControlPosition) g = mxUtils.getValue(a.style, mxConstants.STYLE_ROTATION, 0);
                ...
                e = e + h,
                f = f - h;
            0 != g && (h = mxUtils.toRadians(g), g = Math.cos(h), h = Math.sin(h), f = mxUtils.getRotatedPoint(new mxPoint(e, f), g, h, new mxPoint(a.getCenterX(), a.getCenterY())), e = f.x, f = f.y)
        }
        return a.view.graph.getModel().isEdge(a.cell),
            new mxRectangle(Math.round(e - c / 2 * d), Math.round(f - b / 2 * d), Math.round(c * d), Math.round(b * d))
    }
    return null
};
...
mxCellRenderer.prototype.redrawShape = function(a, b, c) {
    var d = !1;
    if (null != a.shape && (this.createControl(a), mxUtils.equalEntries(a.shape.style, a.style) || (this.configureShape(a), b = !0), b || null == a.shape.bounds || a.shape.scale != a.view.scale || null == a.absolutePoints && !a.shape.bounds.equals(a) || null != a.absolutePoints && !mxUtils.equalPoints(a.shape.points, a.absolutePoints))) null != a.absolutePoints ? (a.shape.points = a.absolutePoints.slice(), a.shape.bounds = null) : (a.shape.points = null, a.shape.bounds = new mxRectangle(a.x, a.y, a.width, a.height)),
...
var mxEdgeStyle = {
        EntityRelation: function(a, b, c, d, e) {
            ...
            null != b && null != c && (a = h ? b.x: b.x + b.width, b = f.getRoutingCenterY(b), g = k ? c.x: c.x + c.width, c = f.getRoutingCenterY(c), f = new mxPoint(a + (h ? -d: d), b), l = new mxPoint(g + (k ? -d: d), c), h == k ? (d = h ? Math.min(a, g) - d: Math.max(a, g) + d, e.push(new mxPoint(d, b)), e.push(new mxPoint(d, c))) : (f.x < l.x == h ? (d = b + (c - b) / 2, e.push(f), e.push(new mxPoint(f.x, d)), e.push(new mxPoint(l.x, d))) : e.push(f), e.push(l)))
        },
        Loop: function(a, b, c, d, e) {
            if (null != b) {
                ...
                a == mxConstants.DIRECTION_NORTH || a == mxConstants.DIRECTION_SOUTH ? (g = c.getRoutingCenterX(b), h = f) : (k = c.getRoutingCenterY(b), l = f);
        ...
        ElbowConnector: function(a, b, c, d, e) {
            var f = null != d && 0 < d.length ? d[0] : null,
                g = !1,
                h = !1;
            if (null != b && null != c) if (null != f) var k = Math.min(b.x, c.x),
                ...
                g = f.y < h || f.y > m,
                h = f.x < k || f.x > l;
            else k = Math.max(b.x, c.x),
                    l = Math.min(b.x + b.width, c.x + c.width),
                    g = k == l,
                g || (h = Math.max(b.y, c.y), m = Math.min(b.y + b.height, c.y + c.height), h = h == m); ! h && (g || a.style[mxConstants.STYLE_ELBOW] == mxConstants.ELBOW_VERTICAL) ? mxEdgeStyle.TopToBottom(a, b, c, d, e) : mxEdgeStyle.SideToSide(a, b, c, d, e)
        },
        SideToSide: function(a, b, c, d, e) {
            ...
            null != b && null != c && (a = Math.max(b.x, c.x), h = Math.min(b.x + b.width, c.x + c.width), a = null != d ? d.x: h + (a - h) / 2, h = f.getRoutingCenterY(b), f = f.getRoutingCenterY(c), null != d && (d.y >= b.y && d.y <= b.y + b.height && (h = d.y), d.y >= c.y && d.y <= c.y + c.height && (f = d.y)), !mxUtils.contains(c, a, h) && !mxUtils.contains(b, a, h) && e.push(new mxPoint(a, h)), !mxUtils.contains(c, a, f) && !mxUtils.contains(b, a, f) && e.push(new mxPoint(a, f)), 1 == e.length && (null != d ? !mxUtils.contains(c, a, d.y) && !mxUtils.contains(b, a, d.y) && e.push(new mxPoint(a, d.y)) : (f = Math.max(b.y, c.y), b = Math.min(b.y + b.height, c.y + c.height), e.push(new mxPoint(a, f + (b - f) / 2)))))
        },
        TopToBottom: function(a, b, c, d, e) {
            ...
            null != h && (b = new mxCellState, b.x = h.x, b.y = h.y);
            null != g && (c = new mxCellState, c.x = g.x, c.y = g.y);
            null != b && null != c && (h = Math.max(b.y, c.y), g = Math.min(b.y + b.height, c.y + c.height), a = f.getRoutingCenterX(b), null != d && (d.x >= b.x && d.x <= b.x + b.width) && (a = d.x), h = null != d ? d.y: g + (h - g) / 2, !mxUtils.contains(c, a, h) && !mxUtils.contains(b, a, h) && e.push(new mxPoint(a, h)), a = null != d && d.x >= c.x && d.x <= c.x + c.width ? d.x: f.getRoutingCenterX(c), !mxUtils.contains(c, a, h) && !mxUtils.contains(b, a, h) && e.push(new mxPoint(a, h)), 1 == e.length && (null != d && 1 == e.length ? !mxUtils.contains(c, d.x, h) && !mxUtils.contains(b, d.x, h) && e.push(new mxPoint(d.x, h)) : (f = Math.max(b.x, c.x), b = Math.min(b.x + b.width, c.x + c.width), e.push(new mxPoint(f + (b - f) / 2, h)))))
        },
        SegmentConnector: function(a, b, c, d, e) {
            ...
            if (null != d && 0 < d.length) {
                ...
                g && (null != f[0] && f[0].y != h.y || null == f[0] && null != b && (h.y < b.y || h.y > b.y + b.height)) ? e.push(new mxPoint(k.x, h.y)) : !g && (null != f[0] && f[0].x != h.x || null == f[0] && null != b && (h.x < b.x || h.x > b.x + b.width)) && e.push(new mxPoint(h.x, k.y));
                g ? k.y = h.y: k.x = h.x;
                for (r = 0; r < d.length; r++) g = !g,
                    h = a.view.transformControlPoint(a, d[r]),
                    g ? k.y = h.y: k.x = h.x,
                    e.push(k.clone())
            } else h = k,
                g = !0;
        ...
        OrthConnector: function(a, b, c, d, e) {
            ...
            if (mxEdgeStyle.orthPointsFallback && null != d && 0 < d.length || g || f) mxEdgeStyle.SegmentConnector(a, b, c, d, e);
                ...
                a = [0, 0];
                d = [[d, g, l, m], [n, p, q, s]];
                for (l = 0; 2 > l; l++) mxEdgeStyle.limits[l][1] = d[l][0] - f,
                    mxEdgeStyle.limits[l][2] = d[l][1] - f,
                    mxEdgeStyle.limits[l][4] = d[l][0] + d[l][2] + f,
                ...
                for (l = 0; 2 > l; l++) if (0 == a[l] && (0 == (p[l][0] & r[l]) && (p[l][0] = p[l][1]), c[l] = p[l][0] & r[l], c[l] |= (p[l][1] & r[l]) << 8, c[l] |= (p[1 - l][l] & r[l]) << 16, c[l] |= (p[1 - l][1 - l] & r[l]) << 24, 0 == (c[l] & 15) && (c[l] <<= 8), 0 == (c[l] & 3840) && (c[l] = c[l] & 15 | c[l] >> 8), 0 == (c[l] & 983040) && (c[l] = c[l] & 65535 | (c[l] & 251658240) >> 8), a[l] = c[l] & 15, r[l] == mxConstants.DIRECTION_MASK_WEST || r[l] == mxConstants.DIRECTION_MASK_NORTH || r[l] == mxConstants.DIRECTION_MASK_EAST || r[l] == mxConstants.DIRECTION_MASK_SOUTH)) a[l] = r[l];
                ...
                for (l = k = 0; l < r.length; l++) {
                    ...
                    var t = 0 < (r[l] & mxEdgeStyle.TARGET_MASK),
                        ...
                        n = n << g;
                    15 < n && (n >>= 4);
                    p = 0 < (r[l] & mxEdgeStyle.CENTER_MASK); (q || t) && 9 > n ? (s = 0, q = q ? 0 : 1, s = p && 0 == k ? d[q][0] + b[q][0] * d[q][2] : p ? d[q][1] + b[q][1] * d[q][3] : mxEdgeStyle.limits[q][n], 0 == k ? (n = (s - mxEdgeStyle.wayPoints1[f][0]) * m[0], 0 < n && (mxEdgeStyle.wayPoints1[f][0] += m[0] * n)) : (n = (s - mxEdgeStyle.wayPoints1[f][1]) * m[1], 0 < n && (mxEdgeStyle.wayPoints1[f][1] += m[1] * n))) : p && (mxEdgeStyle.wayPoints1[f][0] += m[0] * Math.abs(mxEdgeStyle.vertexSeperations[s] / 2), mxEdgeStyle.wayPoints1[f][1] += m[1] * Math.abs(mxEdgeStyle.vertexSeperations[s] / 2));
                    0 < f && mxEdgeStyle.wayPoints1[f][k] == mxEdgeStyle.wayPoints1[f - 1][k] ? f--:c = k
                }
                for (l = 0; l <= f && !(l == f && ((0 < (a[1] & (mxConstants.DIRECTION_MASK_EAST | mxConstants.DIRECTION_MASK_WEST)) ? 0 : 1) == h ? 0 : 1) != (f + 1) % 2); l++) e.push(new mxPoint(mxEdgeStyle.wayPoints1[l][0], mxEdgeStyle.wayPoints1[l][1]))
            }
        },
...
mxGraphView.prototype.validateBackgroundPage = function() {
    if (this.graph.pageVisible) {
        ...
        null == this.backgroundPageShape ? (this.backgroundPageShape = this.createBackgroundPageShape(a), this.backgroundPageShape.scale = this.scale, this.backgroundPageShape.isShadow = !0, this.backgroundPageShape.dialect = this.graph.dialect, this.backgroundPageShape.init(this.backgroundPane), this.backgroundPageShape.redraw(), graph.nativeDblClickEnabled && mxEvent.addListener(this.backgroundPageShape.node, "dblclick", mxUtils.bind(this,
            function(a) {
...
mxGraphView.prototype.validateBounds = function(a, b) {
    ...
    if (null != d) {
            ...
            if (d.invalid && b != this.currentRoot && null != a) {
                ...
                if (null != e) {
                    if (!c.isEdge(b)) {
                        ...
                        e.relative ? (d.origin.x += e.x * a.width / this.scale + f.x, d.origin.y += e.y * a.height / this.scale + f.y) : (d.absoluteOffset.x = this.scale * f.x, d.absoluteOffset.y = this.scale * f.y, d.origin.x += e.x, d.origin.y += e.y)
                    }
        ...
        if (!this.graph.isCellCollapsed(b) || b == this.currentRoot) {
            e = c.getChildCount(b);
            for (f = 0; f < e; f++) g = c.getChildAt(b, f),
...
mxGraphView.prototype.validatePoints = function(a, b) {
    ...
    if (null != d) {
        ...
        if (c.isEdge(b) || c.isVertex(b)) this.stateValidated(d),
        null != d.shape && null != d.shape.boundingBox && (e = d.shape.boundingBox.clone()),
    ...
    if (null != d && (!this.graph.isCellCollapsed(b) || b == this.currentRoot)) {
        f = c.getChildCount(b);
        for (g = 0; g < f; g++) h = c.getChildAt(b, g),
            h = this.validatePoints(d, h),
        null != h && (null == e ? e = h: e.add(h))
    }
    return e
};
...
mxGraphView.prototype.updateFloatingTerminalPoint = function(a, b, c, d) {
    ...
    h += parseFloat(a.style[d ? mxConstants.STYLE_SOURCE_PERIMETER_SPACING: mxConstants.STYLE_TARGET_PERIMETER_SPACING] || 0);
...
mxGraphView.prototype.getPoint = function(a, b) {
    ...
    if (null != a.segments && (null == b || b.relative)) {
        for (var e = a.absolutePoints.length,
                 f = ((null != b ? b.x / 2 : 0) + 0.5) * a.length, g = a.segments[0], h = 0, k = 1; f > h + g && k < e - 1;) h += g,
            g = a.segments[k++];
        e = 0 == g ? 0 : (f - h) / g;
    ...
    } else null != b && (l = b.offset, null != l && (c += l.x, d += l.y));
    return new mxPoint(c, d)
};
mxGraphView.prototype.getRelativePoint = function(a, b, c) {
    ...
    if (null != d) {
        ...
        if (d.relative && 1 < e) {
            for (var d = a.length,
                     f = a.segments,
                     g = a.absolutePoints[0], h = a.absolutePoints[1], k = mxUtils.ptSegDistSq(g.x, g.y, h.x, h.y, b, c), l = 0, m = 0, n = 0, p = 2; p < e; p++) m += f[p - 2],
                h = a.absolutePoints[p],
...
mxGraphView.prototype.createState = function(a) {
    ...
    var b = this.graph.getModel();
    this.isRendering() && (null != a.view.graph.container && a.cell != a.view.currentRoot && (b.isVertex(a.cell) || b.isEdge(a.cell))) && this.graph.cellRenderer.createShape(a);
    return a
};
...
mxGraphView.prototype.createHtml = function() {
    ...
    null != a && (this.canvas = this.createHtmlPane("100%", "100%"), this.backgroundPane = this.createHtmlPane("1px", "1px"), this.drawPane = this.createHtmlPane("1px", "1px"), this.overlayPane = this.createHtmlPane("1px", "1px"), this.canvas.appendChild(this.backgroundPane), this.canvas.appendChild(this.drawPane), this.canvas.appendChild(this.overlayPane), a.appendChild(this.canvas), mxClient.IS_QUIRKS && (a = mxUtils.bind(this,
        function(a) {
...
mxLoadResources && mxResources.add(mxClient.basePath + "/" + mxClient.resourcePath + "/graph");
...
mxGraph.prototype.processChange = function(a) {
    ...
    this.resetViewOnRootChange && (this.view.scale = 1, this.view.translate.x = 0, this.view.translate.y = 0),
        ...
        null == b && (this.view.invalidate(a.child, !0, !0), this.removeStateForCell(a.child), this.view.currentRoot == a.child && this.home());
...
mxGraph.prototype.updatePageBreaks = function(a, b, c) {
    ...
    if (null != this.verticalPageBreaks) {
        for (g = 0; g <= a; g++) h = [new mxPoint(1, e.y + g * e.height), new mxPoint(b, e.y + g * e.height)],
            null != this.verticalPageBreaks[g] ? (this.verticalPageBreaks[g].points = h, this.verticalPageBreaks[g].redraw()) : (h = new mxPolyline(h, this.pageBreakColor, d), h.dialect = this.dialect, h.isDashed = this.pageBreakDashed, h.init(this.view.backgroundPane), h.redraw(), this.verticalPageBreaks[g] = h);
                ...
                if (null != k && null != l) {
                    ...
                    if (this.model.isEdge(c[e])) {
                        for (var k = k.absolutePoints,
                                 n = this.model.getTerminal(a[e], !0), p = mxCellPath.create(n); null != n && null == d[p];) n = this.model.getParent(n),
                            p = mxCellPath.create(n);
                        null == n && h.setTerminalPoint(new mxPoint(k[0].x / f - g.x, k[0].y / f - g.y), !0);
                        n = this.model.getTerminal(a[e], !1);
                        for (p = mxCellPath.create(n); null != n && null == d[p];) n = this.model.getParent(n),
                            p = mxCellPath.create(n);
                        null == n && (n = k.length - 1, h.setTerminalPoint(new mxPoint(k[n].x / f - g.x, k[n].y / f - g.y), !1));
                        h = h.points;
                        if (null != h) for (k = 0; k < h.length; k++) h[k].x += m,
                            h[k].y += l
                    } else h.x += m,
                        h.y += l
                }
...
mxGraph.prototype.cellsAdded = function(a, b, c, d, e, f, g) {
    if (null != a && null != b && null != c) {
        this.model.beginUpdate();
        try {
            for (var h = f ? this.view.getState(b) : null, k = null != h ? h.origin: null, l = new mxPoint(0, 0), h = 0; h < a.length; h++) if (null == a[h]) c--;
            else {
                ...
                if (null != k && a[h] != b && b != m) {
                    ...
                    if (null != q) {
                        var s = p.x - k.x,
                            r = p.y - k.y,
                            q = q.clone();
                        q.translate(s, r); ! q.relative && (this.model.isVertex(a[h]) && !this.isAllowNegativeCoordinates()) && (q.x = Math.max(0, q.x), q.y = Math.max(0, q.y));
        ...
        try {
            ...
            if (null != c && null != d) {
                ...
                if (this.isSwimlane(a)) {
                    ...
                    null == h && (h = "");
                    mxUtils.getValue(g, mxConstants.STYLE_HORIZONTAL, !0) ? (h = mxUtils.setStyle(h, mxConstants.STYLE_STARTSIZE, c.height + 8), e && (d.height = c.height + 8), d.width = c.width) : (h = mxUtils.setStyle(h, mxConstants.STYLE_STARTSIZE, c.width + 8), e && (d.width = c.width + 8), d.height = c.height);
...
mxGraph.prototype.getPreferredSizeForCell = function(a) {
    ...
    if (null != a) {
        ...
        if (null != d && !this.model.isEdge(a)) {
            ...
            null != c && (f += c.width + 8);
            a = this.getLabel(a);
            null != a && 0 < a.length ? (a = a.replace(/\n/g, "<br>"), a = mxUtils.getSizeForString(a, e, d[mxConstants.STYLE_FONTFAMILY]), f = a.width + f, b = a.height + b, mxUtils.getValue(d, mxConstants.STYLE_HORIZONTAL, !0) || (d = b, b = f, f = d), this.gridEnabled && (f = this.snap(f + this.gridSize / 2), b = this.snap(b + this.gridSize / 2)), b = new mxRectangle(0, 0, f, b)) : (d = 4 * this.gridSize, b = new mxRectangle(0, 0, d, d))
        }
    }
    return b
};
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if (null != e) for (d = 0; d < e.length; d++) {
                    var f = this.view.getState(e[d]),
                        ...
                        l = mxCellPath.create(h); (null == b[k] || null == b[l]) && this.resetEdge(e[d])
                }
...
mxGraph.prototype.getConnectionPoint = function(a, b) {
    ...
    if (null != a) {
        ...
        b.perimeter ? (0 != g && null != c && (h = d = 0, 90 == g ? h = 1 : 180 == g ? d = -1 : 270 == f && (h = -1), c = mxUtils.getRotatedPoint(c, d, h, e)), null != c && b.perimeter && (c = this.view.getPerimeterPoint(a, c, !1))) : f += g;
...
mxGraph.prototype.zoom = function(a, b) {
    ...
    } else this.view.setScale(c),
    mxUtils.hasScrollbars(this.container) && (e = d = 0, b && (d = this.container.offsetWidth * (a - 1) / 2, e = this.container.offsetHeight * (a - 1) / 2), this.container.scrollLeft = Math.round(this.container.scrollLeft * a + d), this.container.scrollTop = Math.round(this.container.scrollTop * a + e))
};
...
mxGraph.prototype.getEdges = function(a, b, c, d, e, f) {
    ...
    h = [];
    for (l = 0; l < g.length; l++) m = this.view.getState(g[l]),
...
mxGraph.prototype.getEdgesBetween = function(a, b, c) {
    ...
    for (var d = this.getEdges(a), e = [], f = 0; f < d.length; f++) {
        var g = this.view.getState(d[f]),
            ...
            g = null != g ? g.getVisibleTerminal(!1) : this.view.getVisibleTerminal(d[f], !1); (h == a && g == b || !c && h == b && g == a) && e.push(d[f])
    }
    return e
};
    ...
    if (null != a) {
        for (var e = this.getModel(), f = e.getChildCount(a), g = null, h = 0, k = 0; k < f; k++) {
            ...
            if (this.model.isVertex(l) && this.isCellVisible(l)) {
                for (var m = this.getConnections(l, b ? a: null), n = 0, p = 0, q = 0; q < m.length; q++) this.view.getVisibleTerminal(m[q], !0) == l ? n++:p++; (c && 0 == n && 0 < p || !c && 0 == p && 0 < n) && d.push(l);
                m = c ? p - n: n - p;
                m > h && (h = m, g = l)
            }
        }
...
mxGraph.prototype.traverse = function(a, b, c, d, e) {
    if (null != c && null != a) {
        ...
        if (null == e[f] && (e[f] = a, d = c(a, d), null == d || d)) if (d = this.model.getEdgeCount(a), 0 < d) for (f = 0; f < d; f++) {
            ...
            if (!b || h) h = this.model.getTerminal(g, !h),
                this.traverse(h, b, c, g, e)
        }
    }
};
...
mxGraph.prototype.isEventSourceIgnored = function(a, b) {
    ...
    return a == mxEvent.MOUSE_DOWN && ("select" == c || "option" == c || "button" == c || "a" == c || "input" == c)
};
    ...
    if (this.isEventSourceIgnored(a, b)) null != this.tooltipHandler && this.tooltipHandler.hide();
        ...
        if (!this.nativeDblClickEnabled && !mxEvent.isPopupTrigger(b.getEvent()) || this.doubleTapEnabled && mxClient.IS_TOUCH && mxEvent.isTouchEvent(b.getEvent())) {
            ...
            if (this.isEnabled()) if (!mxClient.IS_QUIRKS && a == mxEvent.MOUSE_DOWN || mxClient.IS_QUIRKS && a == mxEvent.MOUSE_UP && !this.fireDoubleClick) {
                ...
                this.lastTouchCell = null; (null != a || mxEvent.isTouchEvent(b.getEvent()) && (mxClient.IS_GC || mxClient.IS_SF)) && Math.abs(this.lastTouchX - b.getX()) < this.doubleTapTolerance && Math.abs(this.lastTouchY - b.getY()) < this.doubleTapTolerance ? this.dblClick(b.getEvent(), a) : mxEvent.consume(b.getEvent());
                return
            }
        }
...
mxSpaceManager.prototype.shiftCell = function(a, b, c, d, e, f, g, h, k, l) {
    ...
    if (null != m) {
        ...
        if (null != p) {
            n.beginUpdate();
            try {
                if (this.isShiftRightwards()) if (m.x >= f) p = p.clone(),
                    p.translate( - b, 0);
                else {
                ...
                if (this.isShiftDownwards()) if (m.y >= g) p = p.clone(),
                    p.translate(0, -c);
                else {
...
mxCellStatePreview.prototype.show = function(a) {
    ...
    for (d in this.deltas) e = mxCellPath.resolve(c, d),
        f = this.graph.view.getState(e),
        g = this.deltas[d],
        e = this.graph.view.getState(b.getParent(e)),
...
mxCellStatePreview.prototype.translateState = function(a, b, c, d) {
    if (null != b) {
        ...
        if (e.isVertex(b.cell)) {
            ...
            if ((0 != c || 0 != d) && null != a && (!a.relative || null != this.deltas[f])) b.x += c,
                b.y += d
        }
...
mxCellStatePreview.prototype.revalidateState = function(a, b, c, d, e) {
    if (null != b) {
        ...
        if ((0 != c || 0 != d) && null != h && h.relative && g.isVertex(b.cell) && (null == a || g.isVertex(a.cell) || null != this.deltas[f])) b.x += c,
            b.y += d,
    ...
    if (!b.isConsumed() && c.isMouseDown && null != this.cell && null != this.first && null != this.bounds) {
        ...
        if (null != this.shape || Math.abs(e) > f || Math.abs(d) > f) {
            ...
            var k = c.isCloneEvent(b.getEvent()) && c.isCellsCloneable() && this.isCloneEnabled(),
                ...
                l = !1;
            null != e && null == g && (h.getParent(this.cell) != f || k) ? (this.target != f && (this.target = f, this.setHighlightColor(mxConstants.DROP_TARGET_COLOR)), l = !0) : (this.target = null, this.connectOnDrop && (null != d && 1 == this.cells.length && c.getModel().isVertex(d) && c.isCellConnectable(d)) && (e = c.getView().getState(d), null != e && (c = null == c.getEdgeValidationError(null, this.cell, d) ? mxConstants.VALID_COLOR: mxConstants.INVALID_CONNECT_TARGET_COLOR, this.setHighlightColor(c), l = !0)));
            null != e && l ? this.highlight.highlight(e) : this.highlight.hide()
        }
        b.consume();
        mxEvent.consume(b.getEvent())
    } else if ((this.isMoveEnabled() || this.isCloneEnabled()) && this.updateCursor && !b.isConsumed() && null != b.getState() && !c.isMouseDown) e = c.getCursorForCell(b.getCell()),
    ...
    if (!b.isConsumed()) {
        ...
        if (null != this.cell && null != this.first && null != this.shape && null != this.currentDx && null != this.currentDy) {
            var d = c.getView().scale,
                ...
                d = this.currentDy / d,
                g = b.getCell();
            this.connectOnDrop && null == this.target && null != g && c.getModel().isVertex(g) && c.isCellConnectable(g) && c.isEdgeValid(null, this.cell, g) ? c.connectionHandler.connect(this.cell, g, b.getEvent()) : (g = this.target, c.isSplitEnabled() && c.isSplitTarget(g, this.cells, b.getEvent()) ? c.splitEdge(g, this.cells, null, f, d) : this.moveCells(this.cells, f, d, e, this.target, b.getEvent()))
...
mxPanningHandler.prototype.mouseDown = function(a, b) { ! b.isConsumed() && (this.isPanningEnabled() && !this.active && this.isPanningTrigger(b)) && (this.start(b), this.consumePanningTrigger(b))
};
...
mxPanningHandler.prototype.mouseMove = function(a, b) {
    ...
    } else this.panningTrigger && (e = this.active, this.active = Math.abs(c) > this.graph.tolerance || Math.abs(d) > this.graph.tolerance, !e && this.active && this.fireEvent(new mxEventObject(mxEvent.PAN_START, "event", b))); (this.active || this.panningTrigger) && b.consume()
};
...
mxCellMarker.prototype.process = function(a) {
    ...
    if (this.isEnabled()) {
        ...
        if (b != this.markedState || a != this.currentColor) this.currentColor = a,
            null != b && null != this.currentColor ? (this.markedState = b, this.mark()) : null != this.markedState && (this.markedState = null, this.unmark())
    }
    return b
};
...
mxConnectionHandler.prototype.createMarker = function() {
    ...
    a.getCell = mxUtils.bind(this,
        function(b, c) {
            ...
            null != c ? this.isConnecting() ? null != this.previous && (this.error = this.validateConnection(this.previous.cell, c), null != this.error && 0 == this.error.length && (c = null, this.isCreateTarget() && (this.error = null))) : this.isValidSource(c) || (c = null) : this.isConnecting() && (!this.isCreateTarget() && !this.graph.allowDanglingEdges) && (this.error = "");
            return c
        });
...
mxConnectionHandler.prototype.mouseMove = function(a, b) {
    if (!b.isConsumed() && (this.ignoreMouseDown || null != this.first || !this.graph.isMouseDown)) { ! this.isEnabled() && null != this.currentState && (this.destroyIcons(), this.currentState = null); (null != this.first || this.isEnabled() && this.graph.isEnabled()) && this.updateCurrentState(b);
        if (null != this.first) {
            var c = this.graph.getView().scale,
                c = new mxPoint(this.graph.snap(b.getGraphX() / c) * c, this.graph.snap(b.getGraphY() / c) * c),
                d = null,
                e = c;
            null != this.constraintHandler.currentConstraint && (null != this.constraintHandler.currentFocus && null != this.constraintHandler.currentPoint) && (d = this.constraintHandler.currentConstraint, e = this.constraintHandler.currentPoint.clone());
            var f = this.first;
            if (null != this.selectedIcon) {
                var g = this.selectedIcon.bounds.width,
                    h = this.selectedIcon.bounds.height;
                null != this.currentState && this.targetConnectImage ? (g = this.getIconPosition(this.selectedIcon, this.currentState), this.selectedIcon.bounds.x = g.x, this.selectedIcon.bounds.y = g.y) : (g = new mxRectangle(b.getGraphX() + this.connectIconOffset.x, b.getGraphY() + this.connectIconOffset.y, g, h), this.selectedIcon.bounds = g);
            ...
            if (null != this.edgeState) {
                ...
                null != this.currentState && (null == d && (d = this.graph.getConnectionConstraint(this.edgeState, this.previous, !1)), this.edgeState.setAbsoluteTerminalPoint(null, !1), this.graph.view.updateFixedTerminalPoint(this.edgeState, this.currentState, !1, d));
                f = null;
                if (null != this.waypoints) {
                    f = [];
                    for (e = 0; e < this.waypoints.length; e++) d = this.waypoints[e].clone(),
            ...
            } else null != this.currentState && null == this.constraintHandler.currentConstraint && (g = this.getTargetPerimeterPoint(this.currentState, b), null != g && (e = g)),
            null == this.sourceConstraint && null != this.previous && (g = this.getSourcePerimeterPoint(this.previous, null != this.waypoints && 0 < this.waypoints.length ? this.waypoints[0] : e, b), null != g && (f = g));
            ...
            if (null == this.shape && (d = Math.abs(c.x - this.first.x), g = Math.abs(c.y - this.first.y), d > this.graph.tolerance || g > this.graph.tolerance)) this.shape = this.createShape(),
    ...
    if (null != b || this.isCreateTarget() || this.graph.allowDanglingEdges) {
        ...
        try {
            ...
            if (null != f) {
                ...
                null == b && (p = this.graph.getPointForEvent(c, !1), p.x -= this.graph.panDx / this.graph.view.scale, p.y -= this.graph.panDy / this.graph.view.scale, l.setTerminalPoint(p, !1));
                this.fireEvent(new mxEventObject(mxEvent.CONNECT, "cell", f, "event", c, "target", d))
            }
        } catch(q) {
            mxLog.show(),
                mxLog.debug(q.message)
        } finally {
            e.endUpdate()
        }
...
mxConstraintHandler.prototype.update = function(a, b) {
    if (this.isEnabled() && !this.isEventIgnored(a)) {
        ...
        if (null != this.focusIcons && null != this.constraints && (null == a.getState() || this.currentFocus == a.getState())) for (e = 0; e < this.focusIcons.length; e++) if (mxUtils.intersects(this.focusIcons[e].bounds, d)) {
            ...
            null == this.focusHighlight ? (c = new mxRectangleShape(c, null, this.highlightColor, 3), c.dialect = this.graph.dialect == mxConstants.DIALECT_SVG ? mxConstants.DIALECT_SVG: mxConstants.DIALECT_VML, c.init(this.graph.getView().getOverlayPane()), this.focusHighlight = c, h = mxUtils.bind(this,
                function() {
                    return null != this.currentFocus ? this.currentFocus: a.getState()
...
function mxRubberband(a) {
    null != a && (this.graph = a, this.graph.addMouseListener(this), this.forceRubberbandHandler = mxUtils.bind(this,
        ...
        function() {
            this.repaint()
        }), this.graph.addListener(mxEvent.PAN, this.panHandler), mxClient.IS_IE && mxEvent.addListener(window, "unload", mxUtils.bind(this,
        function() {
            this.destroy()
        })))
}
...
mxVertexHandler.prototype.init = function() {
    ...
    if (this.rotationEnabled && this.graph.isCellRotatable(this.state.cell) && (0 >= mxGraphHandler.prototype.maxCells || this.graph.getSelectionCount() < mxGraphHandler.prototype.maxCells) && 2 < this.state.width && 2 < this.state.height) this.rotationShape = this.createSizer("pointer", mxEvent.ROTATION_HANDLE, mxConstants.HANDLE_SIZE + 3, mxConstants.HANDLE_FILLCOLOR),
...
mxVertexHandler.prototype.start = function(a, b, c) {
    ...
    if (this.livePreview) {
        ...
        this.edgeHandlers = [];
        for (b = 0; b < a.length; b++) c = this.graph.selectionCellsHandler.getHandler(a[b]),
        null != c && this.edgeHandlers.push(c)
    } else this.preview = this.createSelectionShape(this.bounds),
    ...
    if (!b.isConsumed() && null != this.index) {
        ...
        if (!this.inTolerance) {
            var c = new mxPoint(b.getGraphX(), b.getGraphY()),
                ...
                e = this.graph.getView().scale;
            if (this.index == mxEvent.LABEL_HANDLE) d && (c.x = this.graph.snap(c.x / e) * e, c.y = this.graph.snap(c.y / e) * e),
                ...
                var h = mxUtils.toRadians(this.state.style[mxConstants.STYLE_ROTATION] || "0"),
                    ...
                    n = l * f + k * g,
                    f = k * f - l * g;
                this.bounds = this.union(this.selectionBounds, f, n, this.index, d, e, c, this.isConstrainedEvent(b));
                k = Math.cos(h);
                l = Math.sin(h);
                ...
                this.bounds.y += m;
                this.livePreview ? (f = new mxRectangle(this.state.x, this.state.y, this.state.width, this.state.height), k = this.state.origin, this.state.x = this.bounds.x, this.state.y = this.bounds.y, this.state.origin = new mxPoint(this.state.x / e - c.x, this.state.y / e - c.y), this.state.width = this.bounds.width, this.state.height = this.bounds.height, e = this.state.absoluteOffset, e = new mxPoint(e.x, e.y), this.state.absoluteOffset.x = 0, this.state.absoluteOffset.y = 0, c = this.graph.getCellGeometry(this.state.cell), null != c && (l = c.offset || this.EMPTY_POINT, null != l && !c.relative && (this.state.absoluteOffset.x = this.state.view.scale * l.x, this.state.absoluteOffset.y = this.state.view.scale * l.y), this.state.view.updateVertexLabelOffset(this.state)), this.state.view.graph.cellRenderer.redraw(this.state, !0), this.state.view.invalidate(this.state.cell), this.state.invalid = !1, this.state.view.validate(), this.redrawHandles(), this.state.x = f.x, this.state.y = f.y, this.state.width = f.width, this.state.height = f.height, this.state.origin = k, this.state.absoluteOffset = e) : this.drawPreview()
            }
        }
        b.consume()
    ...
    if (null != this.index && null != this.state) {
        ...
        try {
            if (this.index == mxEvent.ROTATION_HANDLE) {
                ...
                this.resizeCell(this.state.cell, k / m, l / m, this.index, e, this.isConstrainedEvent(b))
            }
        } finally {
            this.graph.getModel().endUpdate()
        }
...
mxVertexHandler.prototype.resizeCell = function(a, b, c, d, e, f) {
    var g = this.graph.model.getGeometry(a);
    if (null != g) if (d == mxEvent.LABEL_HANDLE) d = this.graph.view.scale,
        b = (this.labelShape.bounds.getCenterX() - this.startX) / d,
        c = (this.labelShape.bounds.getCenterY() - this.startY) / d,
        g = g.clone(),
        null == g.offset ? g.offset = new mxPoint(b, c) : (g.offset.x += b, g.offset.y += c),
        this.graph.model.setGeometry(a, g);
    else {
        d = this.union(g, b, c, d, e, 1, new mxPoint(0, 0), f);
        f = mxUtils.toRadians(this.state.style[mxConstants.STYLE_ROTATION] || "0");
        if (0 != f) {
            b = d.getCenterX() - g.getCenterX();
            c = d.getCenterY() - g.getCenterY();
            e = Math.cos(f);
            var h = Math.sin(f);
            f = e * b - h * c - b;
            b = h * b + e * c - c;
            ...
            d.x += f;
            d.y += b;
            if (!this.graph.isCellCollapsed(a) && (0 != f || 0 != b)) c = g.x - d.x + l,
                k = g.y - d.y + e,
                this.moveChildren(a, c, k)
        }
...
mxVertexHandler.prototype.union = function(a, b, c, d, e, f, g, h) {
    ...
    var k = a.x - g.x * f,
        ...
        m = a.y - g.y * f;
    a = m + a.height;
    4 < d ? (a += c, e && (a = this.graph.snap(a / f) * f)) : 3 > d && (m += c, e && (m = this.graph.snap(m / f) * f));
    if (0 == d || 3 == d || 5 == d) k += b,
    e && (k = this.graph.snap(k / f) * f);
    else if (2 == d || 4 == d || 7 == d) l += b,
    e && (l = this.graph.snap(l / f) * f);
    e = l - k;
    c = a - m;
    h && (h = this.graph.getCellGeometry(this.state.cell), null != h && (h = h.width / h.height, 1 == d || 2 == d || 7 == d || 6 == d ? e = c * h: c = e / h, 0 == d && (k = l - e, m = a - c)));
    0 > e && (k += e, e = Math.abs(e));
    0 > c && (m += c, c = Math.abs(c));
    d = new mxRectangle(k + g.x * f, m + g.y * f, e, c);
    ...
    if (null != this.sizers) {
        if (null == this.index && this.manageSizers && 1 < this.sizers.length) {
            ...
            if (a.width < 2 * this.sizers[0].bounds.width - 2 + 3 * b || a.height < 2 * this.sizers[0].bounds.height - 2 + 3 * b) a = new mxRectangle(a.x, a.y, a.width, a.height),
                b /= 2,
                a.x -= (this.sizers[0].bounds.width + b) / 2,
                a.width += this.sizers[0].bounds.width + b,
                a.y -= (this.sizers[0].bounds.height + b) / 2,
                a.height += this.sizers[0].bounds.height + b
        }
        var b = a.x + a.width,
            c = a.y + a.height;
...
mxEdgeHandler.prototype.createMarker = function() {
    ...
    a.getCell = function(a) {
        ...
        if (d == b.state.cell || null == d) d = this.graph.getCellAt(e.x, e.y),
...
mxEdgeHandler.prototype.getPreviewPoints = function(a) {
    var b = this.graph.getCellGeometry(this.state.cell),
        b = null != b.points ? b.points.slice() : null; ! this.isSource && !this.isTarget ? (this.convertPoint(a, !1), null == b ? b = [a] : b[this.index - 1] = a) : this.graph.resetEdgesOnConnect && (b = null);
    return b
};
mxEdgeHandler.prototype.updatePreviewState = function(a, b, c) {
    ...
    this.isSource ? f = h: this.isTarget && (g = h); (!this.isSource || null != d) && a.view.updateFixedTerminalPoint(a, d, !0, f); (!this.isTarget || null != e) && a.view.updateFixedTerminalPoint(a, e, !1, g);
...
//mxLoadResources && mxResources.add(mxClient.basePath + "/static/global/plugins/mxgraph/resources/editor");
    ...
    a.encodeCell = function(a, c, d) {
        ...
        if (null == g || null != f) {
            ...
            if (null != l) {
                ...
                null != c.graph.getLabel(d) && (m.setAttribute("label", c.graph.getLabel(d)), c.graph.isHtmlLabel(d) && m.setAttribute("html", !0));
                if (null == g) {
                    ...
                    } else m.setAttribute("x", Math.round(f.x)),
                        m.setAttribute("y", Math.round(f.y)),
                        m.setAttribute("width", Math.round(f.width)),
                        m.setAttribute("height", Math.round(f.height));
                    n = f.absoluteOffset;
                    null != n && (0 != n.x && m.setAttribute("dx", Math.round(n.x)), 0 != n.y && m.setAttribute("dy", Math.round(n.y)))
                }
                for (n = 0; n < h; n++) f = this.encodeCell(a, c, e.getChildAt(d, n)),
                null != f && m.appendChild(f)
            }
        }
        return m
    };
        ...
        if (null != d) {
            ...
            for (c = c.firstChild; null != c;) {
                if (c.nodeType == mxConstants.NODETYPE_ELEMENT && !this.processInclude(a, c, d)) if ("separator" == c.nodeName) d.addSeparator();
                    ...
                    else if (null != m || null != p && 0 < p.length) q = e.templates[m],
                        m = c.getAttribute("style"),
                    null != q && null != m && (q = q.clone(), q.setStyle(m)),
                        m = null,
                    null != p && 0 < p.length && (m = mxUtils.eval(p)),
                        q = d.addPrototype(f, g, q, h, m, n);
                    else if (h = mxUtils.getChildNodes(c), 0 < h.length) if (null == g) {
                        m = d.addActionCombo(f);
                        for (f = 0; f < h.length; f++) n = h[f],
                            "separator" == n.nodeName ? d.addOption(m, "---") : "add" == n.nodeName && (g = n.getAttribute("as"), n = n.getAttribute("action"), d.addActionOption(m, g, n))
                    } else {
                        var r = null,
                        ...
                        for (f = 0; f < h.length; f++) n = h[f],
                            "separator" == n.nodeName ? d.addOption(r, "---") : "add" == n.nodeName && (g = n.getAttribute("as"), p = n.getAttribute("template"), d.addOption(r, g, p || m).cellStyle = n.getAttribute("style"))
                    }
